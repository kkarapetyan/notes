...
KeychainItemWrapper *keychainItem = [[KeychainItemWrapper alloc] initWithIdentifier:@"AppLogin" accessGroup:nil];
    ...
    if (username.length == 0) {
        UINavigationController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"LoginNavigationController"];//
        self.window.rootViewController = viewController;
    } else {
        UINavigationController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"NotesNavigationcontroller"];
        self.window.rootViewController = viewController;
    }
